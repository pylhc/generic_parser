...
version = ABOUT_GENERIC_PARSER['__version__'][:3]
# The full version, including alpha/beta/rc tags.
release = ABOUT_GENERIC_PARSER['__version__']
...
htmlhelp_basename = 'genericparserdoc'
...
latex_documents = [
    (master_doc, 'generic-parser.tex', u'generic-parser Documentation',
     u'OMC-TEAM', 'manual'),
]
...
man_pages = [
    (master_doc, 'generic-parser', u'Generic-Parser Documentation',
     [author], 1)
]
